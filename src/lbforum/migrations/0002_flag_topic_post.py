...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.topic_post'
        db.add_column('lbforum_post', 'topic_post', orm['lbforum.post:topic_post'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Post.topic_post'
        db.delete_column('lbforum_post', 'topic_post')
