...
def new_post(request, forum_id=None, topic_id=None, form_class=NewPostForm, \
    ...
    unpublished_attachs = request.user.attachment_set.all()
    unpublished_attachs = unpublished_attachs.filter(activated=False)
    ext_ctx['unpublished_attachments'] = unpublished_attachs
...
def edit_post(request, post_id, form_class=EditPostForm,
    ...
    unpublished_attachments = request.user.attachment_set.all()
    unpublished_attachments = unpublished_attachments.filter(activated=False)
    ext_ctx['unpublished_attachments'] = unpublished_attachments
